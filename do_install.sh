...
GERACLIS_ROOT=/users/juhanika/workspace/geraclis
SOCOL_SRC=$GERACLIS_ROOT/orig/SOCOLv4.0
# YAXT_SRC="..."
# CDI_SRC=
# CDO_SRC=
...
# Configure SOCOL
pushd $SOCOL_SRC && ./configure_socol_lumi --oasis --echam --mpiom --prefix=$SOCOL_SRC
