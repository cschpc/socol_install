...
static const char *SelregionHelp[] = {
    ...
    "               A region is defined by a polygon. Each line of a polygon description file contains the longitude",
    "               and latitude of one point. Each polygon description file can contain one or more polygons separated",
...
static const char *RemapdisHelp[] = {
    ...
    "              Performs an inverse distance weighted average remapping of the nearest neighbors value on all input fields.",
    "              The default number of nearest neighbors is 4.",
...
static const char *Remapcon2Help[] = {
    ...
    "    The interpolation is based on an adapted SCRIP library version. ",
    "    For a detailed description of the interpolation method see SCRIP.",
    "    The second order conservative remapping is not available for unstructured source grids.",
    "    The search algorithm for the conservative remapping requires that no grid cell occurs more than once. ",
    "",
    "OPERATORS",
...
static const char *IntlevelHelp[] = {
    ...
    "",
    "PARAMETER",
    "    levels  FLOAT  Comma-separated list of target levels",
    nullptr
};
...
static const char *EcaPdHelp[] = {
    ...
    "    etccdi_r1mm[,params]  infile outfile",
    "",
    "DESCRIPTION",
