...
genscon -genscon \
genycon -genycon \
genycon2test -genycon2test \
geopotheight -geopotheight \
gh2hl -gh2hl \
gh2hlx -gh2hlx \
gheight -gheight \
gheighthalf -gheighthalf \
globavg -globavg \
gmtcells -gmtcells \
gmtxyz -gmtxyz \
gp2fc -gp2fc \
...
seasmean -seasmean \
seasmin -seasmin \
seasmonavg -seasmonavg \
seasmonmean -seasmonmean \
seaspctl -seaspctl \
seasrange -seasrange \
seasstd -seasstd \
seasstd1 -seasstd1 \
...
setmisstonntime -setmisstonntime \
